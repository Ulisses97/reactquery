...
export default function UserCard({ user, handleedituser }: IUserCardProps) {
  return (
    <div
      style={{
        background:
          "radial-gradient(561.18% 173.97% at -16.61% -23.7%, rgba(94, 23, 181, 0.62) 0%, rgba(225, 200, 255, 0.00) 98.03%)",
        backdropFilter: "blur(50px)",
      }}
      className="w-[575px] rounded-2xl min-h-[270px] flex flex-col justify-between"
    >
      <div className="p-6 w-full flex items-center justify-between">
        <div className="flex flex-col gap-3">
          <div>
            <h3 className="text-[#3DC5EC]">desenvolvedor</h3>
          ...
          <div>
            <h3 className="text-[#3DC5EC]">data de nascimento</h3>
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(90deg, #D9D9D9 7.64%, rgba(217, 217, 217, 0.00) 100%)",
          }}
          className="flex-auto h-[4px] rounded-md"
        ></div>
        <button onClick={handleedituser} className="text-white cursor-pointer">
          editar
        </button>
      </div>
    </div>
